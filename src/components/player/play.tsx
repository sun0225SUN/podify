  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger asChild>
        <PlayButton
          className={cn(
            'group relative inline-flex size-14 cursor-pointer items-center justify-center rounded-full bg-[#262626] text-white outline-none ring-media-focus focus-visible:ring-4 dark:bg-white dark:text-black',
            className,
          )}
