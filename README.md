...
<div align="center">
  ...
  <p>Shutiao Life is a beautiful podcast template built with TanStack Start</p>
...
- [x] 🌐 Multilingual support (zh/en)
- [x] 🎨 Multi-theme color support
- [x] 🍼 RSS data automatic parsing
- [x] 🚀 cmdk quick operation
- [ ] ...
